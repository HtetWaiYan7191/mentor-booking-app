...
booking1 = Booking.create(user_id: kakashi.id, booking_type_id: firstBookingType.id, book_user_name: naruto.name, book_user_email: naruto.name, introduction_text: ' hello kakashi, I am naruto ', status: 0, booking_date: Date.new(2024,3,15) , session_name: 'software engineering', booking_time: Time.new(2024, 3, 15, 10, 30, 0) )
booking2 = Booking.create(user_id: kakashi.id, booking_type_id: firstBookingType.id, book_user_name: naruto.name, book_user_email: naruto.name, introduction_text: ' hello kakashi, I am naruto this is our session 2  ', status: 0, booking_date: Date.new(2024,3,15) , session_name: ' web development ', booking_time: Time.new(2024, 4, 20, 10, 30, 0) )
booking3 = Booking.create(user_id: kakashi.id, booking_type_id: firstBookingType.id, book_user_name: naruto.name, book_user_email: naruto.name, introduction_text: ' This is our session three sensei kakashi  ', status: 0, booking_date: Date.new(2024,3,15) , session_name: '  ninjutsu ', booking_time: Time.new(2024, 4, 25, 10, 30, 0) )
