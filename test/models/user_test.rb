...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    ...
    @mentor = User.new(name: 'mentor', overview: 'I am metor', bio: 'Mentor, Teacher', role: 1,
                       email: 'mentor@email.com', password: 'password')
  ...
  test 'when create a new user default address should be created' do
    @user4 = User.new(name: 'exampleName', overview: 'testOverview', bio: 'testBio', email: 'user4@gmail.com',
                      password: 'password')
  ...
  test "user's address should be deleted when user is deleted" do
    @user3 = User.create(name: 'exampleName', overview: 'testOverview', bio: 'testBio', email: 'user3@gmail.com',
                         password: 'password')
  ...
  test ' user can create an account only filling name, email, password, and password_confirmation ' do
    test_user = User.new(name: 'htet', email: 'htet123@gmail.com', password: 'password',
