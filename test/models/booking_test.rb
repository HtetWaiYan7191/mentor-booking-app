...
class BookingTest < ActiveSupport::TestCase
  ...
  test "should return confilct error if new booking time is not available " do
    booking3 = Booking.new(booking_type_id: @booking_type2.id, mentor_id: @mentor.id, introduction_text: 'this is introduction text from mentee', session_name: 'Web development', mentee_id: @user.id, booking_datetime: DateTime.new(2024, 3, 27, 8, 30, 0))
